...
### 2. Se declaran variables y constantes

 Se declaran las variables :
- map : almacena el objeto que permite interacuar con el mapa.
...
### 5. Se crea la fucnión initializaMap()
...
**L.tileLayer(...).addTo(map);** : Añade la capa visual de fondo al mapa. Solicita las imágenes (tiles) de OpenStreetMap a sus servidores y las muestra en la pantalla, asegurando también la atribución a los colaboradores de OSM.

---

### 7. Se crea la función updateMarkers()
...
### 8. Se crea la función attachEventListeners()
